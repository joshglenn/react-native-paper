...
import IconComboButton from '../IconComboButton';
 ...
 * ```
 */
class ToggleComboButton extends React.Component<Props> {
...
export default withTheme(ToggleComboButton);
