 ...
 * ```js
 * import * as React from 'react';
 * import { IconComboButton, Colors } from 'react-native-paper';
 *
 * const MyComponent = () => (
 *   <IconComboButton
 *     icon="camera"
  ...
  return (
    ...
    >
      <View style={{ alignItems: 'center', }}>
        { icon ? <IconComponent color={iconColor} source={icon} size={size} /> : <></> }
...
export default withTheme(IconComboButton);
